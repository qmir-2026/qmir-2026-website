...
```{r}
#| label: fig-agreescales
#| fig-cap: "Your answers in the agreement/disagreement items."
...
responses |>
  ...
  mutate(
    question = items_map[question] # map variable names to full statements
  ) |>
  ggplot(
  ...
  theme(aspect.ratio = 0.618, axis.text.x = element_text(size = 8)) +
  facet_wrap(~question)
